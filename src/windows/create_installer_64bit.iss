...
[Run]
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""qtbinpatcher --nobackup --qt-dir=/mingw64/bin || sleep 300"""; \
  StatusMsg: "Configuring Qt5..."
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""python3 -m pip install -U --no-cache-dir --disable-pip-version-check photini || sleep 300"""; \
  StatusMsg: "Installing Photini..."
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""python3 -m pip install -U --no-cache-dir --disable-pip-version-check flickrapi keyring || sleep 300"""; \
  StatusMsg: "Installing Flickr uploader..."; \
  Components: flickr
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-gspell || sleep 300"""; \
  StatusMsg: "Installing Spelling checker..."; \
  Components: spell
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-aspell-en || sleep 300"""; \
  StatusMsg: "Installing English dictionaries..."; \
  Components: spell/en
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-aspell-fr || sleep 300"""; \
  StatusMsg: "Installing French dictionaries..."; \
  Components: spell/fr
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-aspell-de || sleep 300"""; \
  StatusMsg: "Installing German dictionaries..."; \
  Components: spell/de
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-aspell-ru || sleep 300"""; \
  StatusMsg: "Installing Russian dictionaries..."; \
  Components: spell/ru
Filename: "{#Shell}"; \
  Parameters: "MSYSTEM=MINGW64 /bin/bash -l -c ""pacman -S --noconfirm mingw-w64-x86_64-aspell-es || sleep 300"""; \
